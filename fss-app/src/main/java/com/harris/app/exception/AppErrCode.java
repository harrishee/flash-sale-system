...
public enum AppErrCode implements ErrorCodeI {
    INVALID_PARAMS("INVALID_PARAMS", "参数错误"),
    TRY_LATER("TRY_LATER", "稍后再试"),
    FREQUENT_ERROR("FREQUENTLY_ERROR", "操作频繁，稍后再试"),
    ...
    ITEM_MODIFY_FAILED("ITEM_MODIFY_FAILED", "抢购品修改失败"),
    ITEM_NOT_FOUND("ITEM_NOT_FOUND", "抢购品不存在"),
    ITEM_NOT_ONLINE("ITEM_NOT_ONLINE", "抢购品未上线"),
    ...
    ITEM_SOLD_OUT("ITEM_SOLD_OUT", "抢购品已售罄"),
    ...
    private AppErrCode(String errCode, String errDesc) {
