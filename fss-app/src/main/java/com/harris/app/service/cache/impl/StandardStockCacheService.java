...
public class StandardStockCacheService implements StockCacheService {
    ...
    public boolean alignItemStocks(Long itemId) {
        ...
        try {
            ...
            if (result == null) {
                log.info("alignItemStocks, alignment failed: {},{},{}", itemId, itemStocksCacheKey, saleItem.getInitialStock());
                return false;
            }
            if (result == -997) {
                log.info("alignItemStocks, alignment canceled: {},{},{},{}", result, itemId, itemStocksCacheKey, saleItem.getInitialStock());
                return true;
            }
            if (result == 1) {
                log.info("alignItemStocks, alignment done: {},{},{},{}", result, itemId, itemStocksCacheKey, saleItem.getInitialStock());
                return true;
            }
            return false;
        } catch (Exception e) {
