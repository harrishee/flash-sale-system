...
public enum DomainErrorCode implements ErrorCodeI {
    ...
    TOTAL_STOCK_AMOUNT_INVALID("TOTAL_STOCK_AMOUNT_INVALID", "库存总数错误"),
    AVAILABLE_AMOUNT_NOT_EQUALS_TO_TOTAL_AMOUNT("AVAILABLE_AMOUNT_NOT_EQUALS_TO_TOTAL_AMOUNT", "子桶可用库存与库存总数不匹配"),
    AVAILABLE_STOCK_AMOUNT_INVALID("AVAILABLE_STOCK_AMOUNT_INVALID", "子桶可用库存数量错误"),
